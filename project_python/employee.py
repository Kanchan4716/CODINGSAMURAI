...
class employeeClass:
    def __init__(self, root):
        ...
        self.EmployeeTable.bind('<<TableSelect>>', self.get_data)
        self.clear()
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                row = cur.fetchone()
                if row is not None:
                    messagebox.showerror("Error", "This Employee ID already assigned, try a different one",
                                         parent=self.root)
                else:
                    cur.execute(
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get() == "Select":
                ...
                # Use the correct field in the query based on the selected search option

...
class monthlyClass:
    def __init__(self, root):
        ...
        self.ExpenseTable.column("S_No", width=2)
        self.ExpenseTable.column("dop", width=30)
        self.ExpenseTable.column("month", width=40)
        self.ExpenseTable.column("item", width=40)
        self.ExpenseTable.column("remaining", width=40)
        self.ExpenseTable.column("given", width=30)
        self.ExpenseTable.column("total", width=30)
        self.ExpenseTable.column("description", width=50)
        self.ExpenseTable.pack(fill=BOTH, expand=1)
        self.ExpenseTable.bind("<ButtonRelease-1>", self.get_data)
        self.ExpenseTable.bind('<<TreeviewSelect>>', self.get_data)
        self.clear()
    ...
    def get_data(self, ev):
      selected_row = self.ExpenseTable.selection()
      if selected_row:

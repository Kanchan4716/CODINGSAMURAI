...
class officeClass:
    def __init__(self, root):
        ...
        SearchFrame = LabelFrame(self.root, text="Search Office Expenses", font=("goudy old style", 12, "bold"), bd=2,
                                 relief=RIDGE, bg="white")
        SearchFrame.place(x=250, y=20, width=600, height=70)

        cmb_search = ttk.Combobox(SearchFrame, textvariable=self.var_searchby,
                                  values=("Select", "Date", "Item Name"), state="readonly",
        ...
        title = Label(self.root, text="Office Expenses", font=("Times new roman", 15, "bold"), bg="black",
        ...
        txt_expense = Entry(self.root, textvariable=self.var_expense, font=("goudy old style", 15),
                            bg="light yellow").place(x=160, y=285, width=180)
        ...
        btn_add = Button(self.root, text="Save",command=self.add,font=("Times new roman", 15, "bold"),
                         bg="#2196f3", fg="white", cursor="hand2").place(x=60, y=440, width=90, height=28)
        btn_update = Button(self.root, text="Update",command=self.update, font=("Times new roman", 15, "bold"),
                            bg="green", fg="white", cursor="hand2").place(x=170, y=440, width=90, height=28)
        btn_delete = Button(self.root, text="Delete",command=self.delete, font=("Times new roman", 15, "bold"),
                            bg="red", fg="white", cursor="hand2").place(x=280, y=440, width=90, height=28)
        btn_clear = Button(self.root, text="Clear",command=self.clear,font=("Times new roman", 15, "bold"),
                           bg="black", fg="white", cursor="hand2").place(x=390, y=440, width=90, height=28)
        ...
        self.officeTable = ttk.Treeview(emp_frame, columns=("S_No","date","item","expense","description"),
        ...
        self.officeTable.bind('<<TableSelect>>', self.get_data)
        self.clear()
